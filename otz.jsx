            ...
            <div className="row">
                <div className="col">
                    <div className="p-3 mb-2 bg-dark text-white rounded border-white">
                        <div align="center"><h1 className="user-select-none">Отзывы о рецептах </h1>
...
function Nav(props){
    return (
        <a 
            ...
            data-bs-toggle="tooltip"
            data-bs-placement="bottom"
            title="Посмотреть список рецептов"
            >
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            <div className="modal-header p-3 mb-2 bg-secondary text-white bg-gradient">
                                <h5 className="modal-title user-select-none" id="ModalLabel">Напишите комментарий и дайте оценку !</h5>
